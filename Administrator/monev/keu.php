  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Laporan Keuangan Bulanan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
echo "<table class='table table-striped table-bordered table-hover col-lg-12 col-md-6 col-sm-4 col-xs-6'>
 ...
 $tahun = $_POST['tahun'];
 $Karyawan = $_POST['kry'];
 $query = mysqli_query($con, "SELECT* from transaksi where  month(tanggal)='$bulan[0]' and year(tanggal) = '$tahun[0]'");
...
<form action="cetak.php" method="POST">
  <input type="hidden" name="bln" value="<?= $bulan[0]; ?>">
  <input type="hidden" name="thn" value="<?= $tahun[0]; ?>">
  <fieldset class='form-group'>
    <div class='form-group'>
    <label>Pengeluaran</label></br>
    <input type='text' value="" style='width:40%;' name='pgl' onkeypress="return hanyaAngka(event)" id='data1' onkeyup="sum();">
    </div>
    <div class='form-group'>
    <label>Pendapatan Bersih</label></br>
    <input type='text' value='' id='data3' style='width:40%;' disabled=""></br>
    <input type="hidden" name='ttl' value="<?=$hasil?>">
    </div>
    <div class='form-group'>
    <label>keterangan</label></br>
    <textarea value='' name="ktr" style='width:40%;'></textarea>
  </div>
  <div class='form-group'>
    <label>Tanggal</label></br>
<input type="text" name="tgl" placeholder="YYYY-MM-DD" value="" style='width:40%;'/>
  </div>
    </fieldset>
