...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="https://localhost/barber/Karyawan/logout.php" class="dropdown-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="https://localhost/barber/Karyawan/" class="brand-link">
...
echo "<table class='table table-striped table-bordered table-hover col-lg-12 col-md-6 col-sm-4 col-xs-6'>
  ...
  $tampil = mysqli_query($con,"SELECT * FROM transaksi where nama_lengkap = '$nama'");
    $no=1;
